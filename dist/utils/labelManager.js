import { issueLabels, prLabels } from '../config/labelColors.js';
// Export a standalone function for ensuring labels exist
export async function ensureLabelsExist(context, labelNames) {
...
export class LabelManager {
     ...
     */
    async applyIssueLabels(issueNumber, issueTitle, issueBody) {
        const labelsToApply = [];
     ...
     */
    async applyPRLabels(prNumber, prTitle) {
        const labelsToApply = [];
     ...
     */
    async addLabels(issueNumber, labelNames) {
        const repo = this.context.repo();
        try {
