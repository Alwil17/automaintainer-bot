 ...
 */
export async function isFirstIssue(context, username) {
 ...
 */
export async function postWelcomeComment(context, issueNumber) {
 ...
 */
export async function isFirstPullRequest(context, username) {
    const repo = context.repo();
    try {
 ...
 */
export async function postWelcomePrComment(context, prNumber) {
    const config = await loadRepoConfig(context);
