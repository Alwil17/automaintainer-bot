 ...
 */
export default async function handleMarketplacePurchase(context) {
 ...
 */
async function handlePurchased(context, purchase, config) {
 ...
 */
async function handleCancelled(context, purchase, config) {
    const accountId = purchase.account.id;
    const accountLogin = purchase.account.login;
 ...
 */
async function handleChanged(context, purchase, config) {
    const accountId = purchase.account.id;
    const accountLogin = purchase.account.login;
 ...
 */
async function handlePendingChange(context, purchase) {
    const accountId = purchase.account.id;
    const accountLogin = purchase.account.login;
 ...
 */
function getWelcomeMessage(planName) {
 ...
 */
function getPlanChangeMessage(newPlanName) {
...
//# sourceMappingURL=marketplacePurchase.js.map